...
/**
 *  \file       core/modules/graphhandler/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_graphhandler
 */
class pdf_standard_graphhandler extends ModelePDFGraphHandler
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
		...
		if ($conf->graphhandler->dir_output.'/graphhandler') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->graphhandler->dir_output.'/graphhandler';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->graphhandler->dir_output.'/graphhandler/'.$objectref;
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		if ($object->statut == $object::STATUS_DRAFT && getDolGlobalString('GRAPHHANDLER_DRAFT_WATERMARK')) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('GRAPHHANDLER_DRAFT_WATERMARK')));
		}

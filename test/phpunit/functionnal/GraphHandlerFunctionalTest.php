...
/**
 * \file    test/phpunit/GraphHandlerFunctionalTest.php
...
/**
 * Class GraphHandlerFunctionalTest
 *
 ...
 *
 * @package Testgraphhandler
 */
class GraphHandlerFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGraphHandler')->click();
		} else {
			// Disable the module
			$this->byHref('modGraphHandler')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/graphhandler/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('graphhandler/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/graphhandler/admin/about.php');
		$this->authenticate();
		return $this->assertContains('graphhandler/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('graphhandlerwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGraphHandler_GraphHandlerTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGraphHandler_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
